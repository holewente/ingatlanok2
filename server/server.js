...
app.get('/',(request,response)=>{
    db.query(`select realestates.id,realestates.createAt,realestates.imageUrl,categories.name from realestates,categories where 
realestates.categoryId=categories.id`,(err, results) =>{
    if(err)
        console.log(err);
    else
